...
export const VIETNAM_PLACES: Place[] = [
  {
    ...
    rating: 4.9,
    topSpots: [
      { name: 'Phố Cổ', image: 'https://images.unsplash.com/photo-1555930058-2977464a93a0?q=80&w=400', rating: 4.8 },
      { name: 'Hồ Gươm', image: 'https://images.unsplash.com/photo-1559592443-7f87a79f6cae?q=80&w=400', rating: 4.9 }
    ],
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1599427303058-f06cbdf4bb91?q=80&w=800',
    rating: 4.8,
    topSpots: [
      { name: 'Đại Nội Huế', image: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?q=80&w=400', rating: 4.9 }
    ],
  ...
  },
  {
    ...
    rating: 4.7,
    topSpots: [
      { name: 'Cầu Vàng', image: 'https://images.unsplash.com/photo-1531737212413-667205e1cda7?q=80&w=400', rating: 5.0 },
  ...
  },
  {
    ...
    rating: 4.9,
    topSpots: [
      { name: 'Chùa Cầu', image: 'https://images.unsplash.com/photo-1599708153386-62e2d0903332?q=80&w=400', rating: 4.8 }
    ],
  ...
  },
  {
    ...
    rating: 4.8,
    topSpots: [
      { name: 'Hồ Tuyền Lâm', image: 'https://images.unsplash.com/photo-1598018554490-256143c7b80a?q=80&w=400', rating: 4.9 }
    ],
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1555930058-2977464a93a0?q=80&w=800',
    rating: 4.6,
    topSpots: [
      { name: 'Dinh Độc Lập', image: 'https://images.unsplash.com/photo-1559592443-7f87a79f6cae?q=80&w=400', rating: 4.7 },
      { name: 'Chợ Bến Thành', image: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?q=80&w=400', rating: 4.4 }
    ],
